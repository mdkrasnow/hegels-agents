-- Hegel's Agents Training Layer Database Schema
-- Database schema for training data persistence and prompt profile management
-- Compatible with PostgreSQL/Supabase
-- Uses timestamptz consistently with existing patterns
